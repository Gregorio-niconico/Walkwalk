...
public class MyInfoActivity extends AppCompatActivity {
            ...
            case R.id.finish:
                ...
                if(userPwd.equals(password)) {
                    if (!userPwd.equals(userPwdNew)) {
                        UserUpdate userUpdate = new UserUpdate(userName, userPwdNew);
                        userUpdate.start();
                        try {
                            userUpdate.join();
    ...
    class UserUpdate extends Thread{
        ...
        public UserUpdate(){user_name=user_pwd="";}

        public UserUpdate(String user_name, String user_pwd) {
...
//            now.setAge(age);
            ans= UserDB.userUpdate(userId,now.getName(),now.getPassword());
        }
